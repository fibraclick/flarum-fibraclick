...
export default class QuickLinksComponent extends Component {
    init() {
        this.links = [
            { icon: 'fas fa-align-left', text: 'WIKI', link: 'https://fibra.click/?utm_source=fibraclick&utm_medium=referral&utm_campaign=mobilelinks' },
            { icon: 'far fa-newspaper', text: 'NEWSLETTER', link: 'https://fibra.click/newsletter/?utm_source=fibraclick&utm_medium=referral&utm_campaign=mobilelinks' },
