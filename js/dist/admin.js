...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('fibraclick-tweaks', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.extensionData["for"]('fibraclick-tweaks').registerSetting({
    ...
    }, m("label", null, "Ads - Between posts content"), m("textarea", {
      className: "FormControl",
      bidi: this.setting('fibraclick.ads.betweenPosts')
    }));
  }).registerSetting(function () {
    return m("div", {
      className: "Form-group"
    }, m("label", null, "Ads - Sidebar"), m("textarea", {
      className: "FormControl",
      bidi: this.setting('fibraclick.ads.sidebar')
    }));
  }).registerSetting({
